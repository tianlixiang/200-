...
@interface CX_ChargeTableViewCell()
{
...
@implementation CX_ChargeTableViewCell

#pragma mark - **************** 初始化单元格 ****************
+(instancetype)cellWithTableView:(UITableView *)tableView indentifier:(NSString *)indentifier
{
    CX_ChargeTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:indentifier];
    if(!cell){
        cell=[[CX_ChargeTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:indentifier];
...
- (UIView *)bottomView {
    ...
    [_payButton setTitle:@"查看物流" forState:UIControlStateNormal];
    
    _payButton.titleLabel.font = [UIFont systemFontOfSize:14];
    
    [_payButton setBackgroundColor:[UIColor colorWithHexString:@"0x94ce68"]];
