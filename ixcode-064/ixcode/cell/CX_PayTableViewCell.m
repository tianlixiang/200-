...
@implementation CX_PayTableViewCell

#pragma mark - **************** 初始化单元格 ****************
+(instancetype)cellWithTableView:(UITableView *)tableView indentifier:(NSString *)indentifier
{
    CX_PayTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:indentifier];
    if(!cell){
        cell=[[CX_PayTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:indentifier];
...
- (UIView *)bottomView {
    ...
    [_payButton setBackgroundColor: [UIColor colorWithHexString:@"0xec384e"]];
